...
function seo($str, $options = array())
{
    ...
    $char_map = array(
        ...
        'ā' => 'a', 'č' => 'c', 'ē' => 'e', 'ģ' => 'g', 'ī' => 'i', 'ķ' => 'k', 'ļ' => 'l', 'ņ' => 'n',
        'š' => 's', 'ū' => 'u', 'ž' => 'z',
        // Chinese (handle as non-translatable characters)
        // Optionally, you can include specific Chinese characters here
        // For example:
        '脹' => 'i', '好' => '',  // Remove these characters
    );
    ...
    // Replace multiple delimiters with a single one
