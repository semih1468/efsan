...
$urunicerikid=$_GET['urunicerik_id'];
$urunicerikcek=$db->prepare('select * from urun_icerik where id=:id');
$urunicerikcek->execute(array('id'=>$urunicerikid));
$urunicerik=$urunicerikcek->fetch(PDO::FETCH_ASSOC);
?>
<div class="row">
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form method="post" data-parsley-validate class="form-horizontal form-label-left"
                    ...
                    <input type="hidden" name="urunicerik_id" value="<?php echo $_GET['urunicerik_id'] ?>">
                    <input type="hidden" name="eski_resim" value="<?php echo $urunicerik['resim'] ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input required type="text" id="last-name" name="sira" value="<?php echo $urunicerik['sira'] ?>"
                                   class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input required type="text" id="last-name" name="baslik"  value="<?php echo $urunicerik['baslik'] ?>"
                                   class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
...
<?php echo $urunicerik['aciklama'] ?>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <button type="submit" name="urunicerik_duzenleme" class="btn btn-success">Kaydet</button>
                        </div>
                    </div>
