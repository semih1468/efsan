...
$faliyetsssid=$_GET['faliyetsss_id'];
$faliyetssscek=$db->prepare('select * from faliyet_sss where id=:id');
$faliyetssscek->execute(array('id'=>$faliyetsssid));
$faliyetsss=$faliyetssscek->fetch(PDO::FETCH_ASSOC);
?>
<div class="row">
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form method="post" data-parsley-validate class="form-horizontal form-label-left"
                    ...
                    <input type="hidden" name="selfID" value="<?php echo $_GET['faliyetsss_id'] ?>">
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name"> Sıra
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input required type="text" id="last-name" name="sira" value="<?php echo $faliyetsss['sira'] ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input required type="text" id="last-name" name="baslik"  value="<?php echo $faliyetsss['baslik'] ?>"
                                   class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
...
<?php echo $faliyetsss['aciklama'] ?>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <button type="submit" name="faliyetsss_duzenleme" class="btn btn-success">Kaydet</button>
                        </div>
                    </div>
