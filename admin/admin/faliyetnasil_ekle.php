...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Faliyet Nasıl Çalışır Sayfası</h2>
                <?php if ($_GET && $_GET['ok']) {
                ...
                <form method="post" data-parsley-validate class="form-horizontal form-label-left"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input required type="file" id="last-name" name="resim" placeholder="Başlığı Yazınız"
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <button type="submit" name="faliyetnasil_ekle" class="btn btn-success">Kaydet</button>
                        </div>
                    </div>
